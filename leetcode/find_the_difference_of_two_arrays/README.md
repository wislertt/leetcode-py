...
**LeetCode:** [Problem 2215](https://leetcode.com/problems/find-the-difference-of-two-arrays/description/)

## Problem Description

Given two **0-indexed** integer arrays `nums1` and `nums2`, return _a list_ `answer` _of size_ `2` where:
