...
def run_preorder(solution_class: type, root_list: list[int | None]):
    root = _nary_from_list(root_list)
    implementation = solution_class()
    return implementation.preorder(root)


def assert_preorder(result: list[int], expected: list[int]) -> bool:
