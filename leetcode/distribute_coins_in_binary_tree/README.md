...
**LeetCode:** [Problem 979](https://leetcode.com/problems/distribute-coins-in-binary-tree/description/)
...
Return _the minimum number of moves required to make every node have exactly one_ coin.
