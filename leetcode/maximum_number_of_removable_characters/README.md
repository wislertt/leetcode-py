...
**LeetCode:** [Problem 1898](https://leetcode.com/problems/maximum-number-of-removable-characters/description/)
...
Return _the **maximum** `k` you can choose such that `p` is still a subsequence of `s` after the removals_.
