...
def run_postorder(solution_class: type, root_list: list[int | None]):
    root = _nary_from_list(root_list)
    implementation = solution_class()
    return implementation.postorder(root)


def assert_postorder(result: list[int], expected: list[int]) -> bool:
