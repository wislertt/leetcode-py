...
**LeetCode:** [Problem 2402](https://leetcode.com/problems/meeting-rooms-iii/description/)
...
Return _the **number** of the room that held the most meetings._ If there are multiple rooms, return the room with the **lowest** number.
