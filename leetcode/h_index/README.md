...
**LeetCode:** [Problem 274](https://leetcode.com/problems/h-index/description/)

## Problem Description

Given an array of integers `citations` where `citations[i]` is the number of citations a researcher received for their `i<sup>th</sup>` paper, return _the researcher's h-index_.
