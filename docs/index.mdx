...
- **{/* problem-count:start */}1404{/* problem-count:end */} problems ready
  to generate**: Grind 75, Blind 75, NeetCode 150,
...
<img
    src="/img/preview/lcpy-preview.gif"
    alt="lcpy gen, pytest red to green, and an ASCII tree in the terminal"
