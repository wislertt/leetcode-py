---
title: "lcpy Quickstart: First Problem in 5 Commands"
...
For the full local-testing workflow, single-case runs, and log output,
see [Test LeetCode Solutions Locally](/practice/test-locally).
